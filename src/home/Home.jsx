...
const Home = () => {
	return (
		<div className='home'>
			<Navbar />
			<img src='https://picsum.photos/2000/1200' alt='lorem' />
			...
			help. There are now a set of mock banners available here in three colours
			and in a range of standard banner sizes: BannersBannersBanners Donate: If
			you use this site regularly and would like to help keep the site on the
